...
parser.add_argument(
    ...
    '--all_phases',
    action = 'store_true',
    help = 'Clean all phase files folders. (3 to 14)'
)
parser.add_argument(
    '--selected_phases',
    '--phase',
    ...
    type = str,
    metavar = '3 3.5 4',
    help = 'List phase files folders to clean out.'
)
...
parser.add_argument(
    ...
    '-e',
    action = 'store_true',
    help = 'Wipe all EGG files.'
)
parser.add_argument(
    '--bam',
    '-b',
    action = 'store_true',
    help = 'Wipe all BAM files.'
)
parser.add_argument(
    '--maya',
    '-mb',
    action = 'store_true',
    help = 'Wipe all Maya binary files.'
)
parser.add_argument(
    '--obj',
    '-o',
    action = 'store_true',
    help = 'Wipe all OBJ files.'
)
parser.add_argument(
    '--fbx',
    '-f',
    action = 'store_true',
    help = 'Wipe all FBX files.'
)
